...
export class ResearcherShareSelectorComponent implements OnInit {
  ...
  onSubmit() {
    if (this.selectedCard) {
      ...
      this.socket.emit('share', this.target_player_index, this.selectedCard, () =>  {
        console.log(`share between ${this.curr_player_index} and ${this.target_player_index} of the card ${this.selectedCard} callbacked`)
