module.exports = [
  {
    ...
    color: 'black',
    adjacent: [
      'Tehran', 'Karachi', 'Riyadh', 'Cairo', 'Istanbul'
    ]
  }, {
    name: 'Bangkok',
    ...
    color: 'yellow',
    adjacent: [
      'Mexico City', 'Miami', 'Sao Paulo', 'Buenos Aires', 'Lima'
    ]
  }, {
    name: 'Buenos Aires',
    ...
    name: 'Cairo',
    location: [30.04442,31.235712],
    color: 'black',
    adjacent: [
      'Istanbul', 'Baghdad', 'Riyadh', 'Khartoum', 'Algiers'
    ]
  }, {
    name: 'Chennai',
    location: [13.08268,80.270718],
    color: 'black',
    adjacent: [
      'Delhi', 'Kolkata', 'Bangkok', 'Jakarta', 'Mumbai'
    ]
  }, {
    name: 'Chicago',
    ...
    color: 'blue',
    adjacent: [
      'Montreal', 'Atlanta', 'Mexico City', 'Los Angeles', 'San Francisco'
    ]
  }, {
    name: 'Delhi',
    ...
    color: 'black',
    adjacent: [
      'Kolkata', 'Tehran', 'Karachi', 'Mumbai', 'Chennai'
    ]
  }, {
    name: 'Essen',
    location: [51.455643,7.011555],
    color: 'blue',
    adjacent: [
      'St Petersburg', 'Milan', 'Paris', 'London'
    ]
  }, {
    ...
    color: 'red',
    adjacent: [
      'Hong Kong', 'Manila', 'Jakarta', 'Bangkok'
    ]
  }, {
    name: 'Hong Kong',
    ...
    color: 'black',
    adjacent: [
      'St Petersburg', 'Moscow', 'Baghdad', 'Cairo', 'Algiers', 'Milan'
    ]
  }, {
    name: 'Jakarta',
    location: [-6.17511,106.865039],
    color: 'red',
    adjacent: [
      'Bangkok', 'Ho Chi Minh City', 'Sydney', 'Chennai'
    ]
  }, {
    name: 'Johannesburg',
    ...
    color: 'black',
    adjacent: [
      'Delhi', 'Hong Kong', 'Bangkok', 'Chennai'
    ]
  }, {
    name: 'Lagos',
    ...
    color: 'yellow',
    adjacent: [
      'San Francisco', 'Sydney', 'Mexico City', 'Chicago'
    ]
  }, {
    name: 'Madrid',
    location: [40.416775,-3.70379],
    color: 'blue',
    adjacent: [
    ...
    name: 'Manila',
    location: [14.599512,120.98422],
    color: 'red',
    adjacent: [
      'Taipei', 'San Francisco', 'Sydney', 'Ho Chi Minh City', 'Hong Kong'
    ]
  }, {
    name: 'Mexico City',
    ...
    color: 'yellow',
    adjacent: [
      'Chicago', 'Miami', 'Bogota', 'Lima', 'Los Angeles'
    ]
  }, {
    name: 'Miami',
    ...
    color: 'blue',
    adjacent: [
      'Montreal', 'London', 'Madrid', 'Washington'
    ]
  }, {
    name: 'Osaka',
    ...
    color: 'blue',
    adjacent: [
      'London', 'Essen', 'Milan', 'Algiers', 'Madrid'
    ]
  }, {
    name: 'Riyadh',
    location: [24.713552,46.675296],
    color: 'black',
    adjacent: [
      'Baghdad', 'Karachi', 'Cairo'
    ]
  }, {
    name: 'San Francisco',
    location: [37.77493,-122.419416],
    color: 'blue',
    adjacent: [
      'Tokyo', 'Manila', 'Los Angeles', 'Chicago'
    ]
  }, {
    name: 'Santiago',
    ...
    color: 'yellow',
    adjacent: [
      'Madrid', 'Lagos', 'Buenos Aires', 'Bogota'
    ]
  }, {
    name: 'Seoul',
    ...
    name: 'St Petersburg',
    location: [59.93428,30.335099],
    color: 'blue',
    adjacent: [
      'Moscow', 'Essen', 'Istanbul'
    ]
  }, {
    name: 'Sydney',
    ...
    name: 'Washington',
    location: [47.751074,-120.740138],
    color: 'blue',
    adjacent: [
      'Montreal', 'New York', 'Miami', 'Atlanta'
    ]
  }
]
