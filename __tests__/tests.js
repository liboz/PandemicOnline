...
describe('City', function () {
  describe('#Infect', function () {
    it('Increases the counter of cubes based on color', function () {
      let g = new game.Game(cities, 2, ["test", "test"], [player.Roles.ContingencyPlanner, player.Roles.Researcher]);
...
describe('Game', function () {
  describe('#Epidemic', function () {
    it('Intensifies', function () {
      let seeded = seedrandom('test!')
      let g = new game.Game(cities, 2, ["test", "test"], [player.Roles.ContingencyPlanner, player.Roles.Researcher], seeded);
  ...
  describe('#Turns', function () {
    it('pass Turns', function () {
      ...
      g = new game.Game(cities, 2, ["test", "test"], [player.Roles.ContingencyPlanner, player.Roles.Researcher]);
      g.decrement_turn()
      expect(g.turns_left).toBe(3)
      g.pass_turn()
      expect(g.turns_left).toBe(0)
...
describe('Player', function () {
  ...
  describe('#Cure', function () {
    it('Scientist with 4 cards', function () {
      let seeded = seedrandom('test!')
      let g = new game.Game(cities, 2, ["test", "test"], [player.Roles.Scientist, player.Roles.Researcher], seeded);
      g.players[0].discard([...g.players[0].hand])
  ...
  describe('#Treat Disease', function () {
    it('Medic Treats All', function () {
      let seeded = seedrandom('test!')
      let g = new game.Game(cities, 2, ["test", "test"], [player.Roles.Medic, player.Roles.Researcher], seeded);
